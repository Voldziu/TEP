...
void UI::v_comp(vector<string> vParamTokens){
    ...
    if(pc_Tree==0){
        ...
        if(*piErrors==2){
            cout<<"\033[1;31mOne of the variables is not a positive integer.\033[0m"<<endl<<"Loaded variables: ";
            ...
            if(iDifference==0){
                cout<<"Succesfully read variable values "<<endl;
                ...
                cout<<"\033[1;31mToo few arguments.\033[0m"<<endl<<"Loaded variables: ";

            }
            v_vars();
            cout<<"Result of a tree with provided values: "<<result<<endl;
